    ...
    <section className="pattern-section section-dark motion-section" id="patterns" aria-labelledby="patterns-title" data-motion-section>
      <div className="container pattern-grid">
        <div className="pattern-copy scroll-reveal">
          ...
          <p>
            Abiade Adire Festival brings fashion, performance, craft, and knowledge into one cultural experience. The current page keeps the textile-led identity, but now frames it as a public celebration.
          </p>
        </div>
        <ul className="pattern-cards" aria-label="Abiade pattern principles">
